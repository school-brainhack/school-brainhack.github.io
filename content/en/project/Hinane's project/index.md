...
title: "This is an example project page which serves as a template (fake)"

# List the names of the collaborators within the [ ]. If alone, simple put your name within []
names: [Samuel Guay, Pierre Bellec, hina]

# Your project GitHub repository URL
github_repo: https://github.com/HinaneB/school

# If you are working on a project that has website, indicate the full url including "https://" below or leave it empty.
website:

# List +- 4 keywords that best describe your project within []. Note that the project summary also involves a number of key words. Those are listed on top of the [github repository](https://github.com/HinaneB/school), click `manage topics`.
...
image: "Brain hack school 2022 Stroke Prediction (13).png"
---
 ...
 * **Project content** Through the project reports generated using the fake template, it is possible to learn about what exactly the brainhack school students are working on.
