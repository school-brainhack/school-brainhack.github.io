...
### Example of Matrix test results graph
...
### Example of a BIDS compatible file structure reformatting
...
#### Tools and skills that were developed during this project
...
#### Tools/skills that were developed during this project (and challenges encountered...)
...
- **Binder**: It has been a difficult journey to try to figure out a way to make available here examples of the interactive figures generated by this project. Unfortunately, Github doesn't allow for html figures to be embedded into markdown files to be displayed. Binder was a way to go around it.
...
### Example of interactive HTML audiogram
...
### Example of Matrix test interactive HTML graph
